 ...
 * Java").
 */
public class VSendAndReceiveEvents extends BasicTest {

    public VSendAndReceiveEvents() {
    }

    public static void main(String[] args) {
        VSendAndReceiveEvents self = new VSendAndReceiveEvents();
        self.runTest();
    }
    ...
    private void runTest() {
        ...
        try {
            ...
            System.out.println("wei shenme meiyougaidongne");
            ...
            sendSensorEvent(engineClient, "S001", 100f);
    ...
    protected void sendTemperatureEvent(EngineClientInterface engineClient, String sensorId, float temperature) throws EngineException {
        System.out.println("Sending temp event...");
    ...
    // float meanPressure;
    // }
    protected void sendSensorEvent(EngineClientInterface engineClient, String sensorId, float meanTemperature) throws EngineException {
        System.out.println("Sending Sensor event...");
